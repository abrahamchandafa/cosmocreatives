...
const ContactContent = ({ isMobile }: { isMobile: boolean }) => {
  ...
  const onSubmit = async (data: FormData) => {
    try {
      const response = await fetch(
        "https://formsubmit.co/ajax/b93b088edfeb25d5199bcf51bb753ed7",
        {
          method: "POST",
          headers: {
  ...
  return (
    <>
      {/* Metadata */}
      <title>Contact Cosmo Creatives</title>
      <meta
        name="description"
        content="Get in touch with Cosmo Creatives. Partner with us for talent management, brand partnerships, and market entry strategies in China."
      />
      <meta
        name="keywords"
        content="contact Cosmo, China talent agency contact, artist management inquiry"
      />
      <meta property="og:title" content="Contact Cosmo Creatives" />
      <meta
        property="og:description"
        content="Partner with us for talent management, brand partnerships, and market entry strategies in China."
      />
      <meta property="og:url" content="https://cosmocreatives.com/contact" />
      <meta
        property="og:image"
      ...
      <link rel="canonical" href="https://cosmocreatives.com/contact" />
      <Stack
        ref={containerRef}
        sx={{
